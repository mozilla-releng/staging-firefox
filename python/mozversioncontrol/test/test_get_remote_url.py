...
STEPS = {
    "hg": [
        """
        echo "[paths]" > .hg/hgrc
        echo "default = https://example.com/fake-repo" >> .hg/hgrc
        echo "default-push = ssh://example.com/fake-repo" >> .hg/hgrc
        echo "try = https://example.com/fake-try-repo" >> .hg/hgrc
        echo "try-push = ssh://example.com/fake-try-repo" >> .hg/hgrc
        """,
    ],
    "git": [
        """
