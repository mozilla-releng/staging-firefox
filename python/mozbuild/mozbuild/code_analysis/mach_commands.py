...
@CommandArgument(
    ...
    "on the remote repository. Without an argument, finds the default remote "
    "that would be pushed to. The upstream revision or remote branch can also "
    "be specified manually. Works with mercurial or git.",
)
def check(
    command_context,
    patterns,
